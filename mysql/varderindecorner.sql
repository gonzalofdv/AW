...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2020 a las 17:52:20
...
(2, 2, 2, '¡Amo a Messi, es mi jugador favorito!', 2),
...
(10, 9, 3, 'Qué? Entonces yo también', 1),
(11, 8, 4, 'Maffeo no es tan bueno como dicen. Prefiero a Mario Suarez', 1),
(12, 10, 4, 'Mourinho nunca llegará a ser tan bueno como lo fue en el Inter', 4),
(17, 1, 7, 'Diego Costa es una leyenda, ojalá se quede muchos años', 3),
(18, 2, 5, 'Está claro que es el mejor...', 4),
(19, 7, 3, 'Este chaval tiene un gran futuro en primera', 2),
(20, 3, 3, 'Con estas acciones se demuestra su buen corazón...', 9),
(21, 11, 2, 'Nooooo, que no se vaya por favor', 3),
(22, 12, 2, 'Bien hecho por su parte, aplausos :)', 4),
(23, 11, 6, 'Ojalá se vaya, ya está mayor.', 0),
(24, 2, 6, 'Para mí Messi es el mejor de todes.', 3),
(25, 6, 6, 'Puede hacer competencia en Chamartín la campaña que viene', 0),
...
--
-- Volcado de datos para la tabla `respuestascomentario`
--

INSERT INTO `respuestascomentario` (`IdRespuestaComentario`, `CodComentario`, `CodUsuario`, `Texto`) VALUES
(1, 1, 7, 'Tú si que eres horrible! No te metas con mi gordito'),
(2, 7, 7, 'Eso es!!!'),
(3, 2, 5, 'No me extraña'),
...
(2, 'Gonzalo', 'Figueroa', 'Del Val', 'hombre', 2, 'gfigue01', '$2y$10$ANx3ithfFe4l6ew3oZhW5uJ45yoyzqUj5SIYn3fuCl/XmtYEnqyeW', 'gfigue01@ucm.es', 0, 1, 320),
