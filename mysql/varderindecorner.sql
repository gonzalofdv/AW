...
(2, 'Gonzalo', 'Figueroa', 'Del Val', 'hombre', 0, 'gfigue01', '$2y$10$ANx3ithfFe4l6ew3oZhW5uJ45yoyzqUj5SIYn3fuCl/XmtYEnqyeW', 'gfigue01@ucm.es', 0, 1, 303),
(3, 'Alvaro', 'Cernuda', 'Vega', 'hombre', 0, 'acernuda', '$2y$10$fuAnn.RfDk4iyTOIkcYlQ.gCWB1evtijABmOAF355GShObXjqWSGi', 'acernuda@ucm.es', 0, 1, 294),
(4, 'Fernando', 'Gonzalez', 'Zamorano', 'hombre', 0, 'fernag08', '$2y$10$.GNAP.NVYpuAh6b5zmATgu1mr/4TVRMzckqd0UyP/vuaPIv87tKj2', 'fernag08@ucm.es', 0, 1, 314),
(5, 'Jorge', 'Borja', 'Garcia', 'hombre', 0, 'jorborja', '$2y$10$9chuTLHd/cRIMM1XLSs3I.mLk4eNESPqBSg5yLMN0T5sNkFjTZdjy', 'jorborja@ucm.es', 0, 1, 332),
(6, 'Alae', 'Edine', 'Mouhib', 'hombre', 0, 'amouhib', '$2y$10$NiV1zfngh25e1BAlessipO6SZ0LnDzG2hvBcLfhTcfiqm3rOuxRoK', 'amouhib@ucm.es', 0, 1, 251),
(7, 'Juan Carlos', 'Rosado', 'Zamorano', 'hombre', 0, 'jurosado', '$2y$10$lvMSB1YxaNhoE7z5.SZl0.zcK.7joA2.uWeXkxQJ/VsJR9peW8klC', 'jurosado@ucm.es', 0, 1, 434),
...
--
ALTER TABLE `comentarios`
  MODIFY `IdComentario` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `respuestascomentario`
  MODIFY `IdRespuestaComentario` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
